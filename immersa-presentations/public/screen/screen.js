...
function render(state) { const index = state.liveSlideIndex ?? state.slideIndex; const item = manifest.slides[index]; slide.src = "/decks/" + deckId + "/" + item.src; applyOverlays(state.overlays || {}); }
