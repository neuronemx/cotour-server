...
function render(state) { const item = manifest.slides[state.slideIndex]; slide.src = "/decks/" + deckId + "/" + item.src; disconnect.classList.toggle("hidden", state.presenterConnected); }
