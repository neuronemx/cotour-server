...
function mountAudiovisualControls() {
  ...
  shell.className = "audiovisual-shell";
  shell.innerHTML = '<video muted playsinline></video>';
  streamArea.appendChild(shell);
  const menu = document.createElement("button");
  menu.className = "audiovisual-menu-button control-button muted-button";
  menu.type = "button"; menu.textContent = "▶";
  menu.onclick = () => shell.classList.toggle("is-open");
