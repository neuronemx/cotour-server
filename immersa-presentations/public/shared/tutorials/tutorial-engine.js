(() => {
  ...
  class TutorialEngine {
    ...
    position() {
      ...
      const top = rect.bottom + 28 + card.offsetHeight > innerHeight ? Math.max(12, rect.top - card.offsetHeight - 28) : Math.min(innerHeight - card.offsetHeight - 12, rect.bottom + 28);
