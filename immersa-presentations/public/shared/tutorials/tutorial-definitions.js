(() => {
  ...
  window.ImmersaTutorials?.boot([{
    ...
    steps: [
      ...
      { id: "deck", target: find("#deckDetailModal:not([hidden]) .deck-detail-modal"), prepare: openDemo, cleanup: () => document.getElementById("closeDeckDetail")?.click(), title: "Este es el home de tu Deck", copy: "Es donde agregas la capa audiovisual y la interactiva. Es donde defines las funciones que estarán disponibles durante tu presentación.", type: "informative" },
      { id: "slides", target: find("#detailSlideStrip"), title: "Slides y miniaturas", copy: "Aquí recorres las slides de tu Deck de forma visual y compruebas que están completas.", type: "informative" },
