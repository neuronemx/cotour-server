...
Crear dentro de esos mismos productos los precios recurrentes en USD. Son importes fijos —no conversiones en tiempo real— y el selector MXN/USD debe enviar al Checkout de la misma moneda elegida.

| Producto | Precio | Importe total | Moneda | Intervalo |
| --- | --- | ---: | --- | --- |
| IMMERSA SPEAKER | mensual | $59.00 | USD | month |
| IMMERSA SPEAKER | anual | $599.00 | USD | year |
| IMMERSA SPEAKER PRO | mensual | $149.00 | USD | month |
| IMMERSA SPEAKER PRO | anual | $1,499.00 | USD | year |
...
Para USD, crear los cupones anuales equivalentes, también con duración `forever`: SPEAKER descuenta USD $120 (precio final USD $479) y SPEAKER PRO descuenta USD $300 (precio final USD $1,199). Conservan el beneficio Founders de aproximadamente 20%, con importes redondeados y fijos.
...
Los precios aprobados por evento son $799.00 MXN para SPEAKER y $1,999.00 MXN para SPEAKER PRO. El Checkout por evento queda como modalidad separada: no debe modelarse como una suscripción recurrente ni activar el entitlement mensual hasta definir su webhook y vigencia.

Los 7 Day Pass aprobados son $799.00 MXN / $1,999.00 MXN y USD $45.00 / USD $115.00, respectivamente, para SPEAKER y SPEAKER PRO. Crear cuatro precios únicos (one-time) separados, uno por plan y moneda.
...
STRIPE_SPEAKER_USD_MONTHLY_PRICE_ID=price_...
STRIPE_SPEAKER_USD_ANNUAL_PRICE_ID=price_...
STRIPE_SPEAKER_PRO_USD_MONTHLY_PRICE_ID=price_...
STRIPE_SPEAKER_PRO_USD_ANNUAL_PRICE_ID=price_...
STRIPE_FOUNDERS_SPEAKER_ANNUAL_COUPON_ID=...
STRIPE_FOUNDERS_SPEAKER_PRO_ANNUAL_COUPON_ID=...
STRIPE_FOUNDERS_SPEAKER_USD_ANNUAL_COUPON_ID=...
STRIPE_FOUNDERS_SPEAKER_PRO_USD_ANNUAL_COUPON_ID=...
STRIPE_SPEAKER_7_DAY_PASS_PRICE_ID=price_...
STRIPE_SPEAKER_PRO_7_DAY_PASS_PRICE_ID=price_...
STRIPE_SPEAKER_USD_7_DAY_PASS_PRICE_ID=price_...
STRIPE_SPEAKER_PRO_USD_7_DAY_PASS_PRICE_ID=price_...
```
